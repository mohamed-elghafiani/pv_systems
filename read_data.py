...
DATA_DIRS = ["data1/ombrage", "data1/Rp", "data1/Rs"]
OMB_DATA = []

data_type_key = "resultsI"
data = {}
for dir_ in DATA_DIRS:
    for i in range(1, 6):
        # load data from data.mat file
        OMB_DATA_1 = sio.loadmat(f"{DATA_DIRS[0]}/{i}/data{i}.mat")
        ...
        data_type_key = get_correct_key(OMB_DATA_1.keys(), data_type_key)
        ...
        # }
        process_to_dict(OMB_DATA_1[data_type_key][0], key, data)


OMB_DATA_1 = sio.loadmat("data1/sans_defaut/1/data.mat")
process_to_dict(OMB_DATA_1["resultsI"][0], "WO", data)
...
# sio.savemat("I_DATA.mat", data)

new_data = sio.loadmat("I_DATA.mat")
print(new_data.keys())
